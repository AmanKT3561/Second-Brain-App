...
export function CreateContentModal({
  ...
  const [type, setType] = useState<typeof contentType[keyof typeof contentType]>(contentType.youtube);
  ...
  async function addContent() {
    ...
    try {
      ...
      // notify other parts of the app to re-fetch content
  ...
  return (
    <div>
      {open && (
        <div>
          <div className="w-screen h-screen bg-slate-500 fixed top-0 left-0 opacity-60 justify-center flex"></div>
